...
const FULL_LIVE_CHANNELS: LiveChannel[] = [
  ...
  { id: 'workpoint-news', name: 'Workpoint News', handle: '@WorkpointNews' },
  { id: 'pptv-hd36', name: 'PPTV HD36', handle: '@PPTVHD36' },
  { id: 'thairath', name: 'Thairath', handle: '@Thairath' },
...
const _REGION_ENTRIES: { key: string; labelKey: string; channelIds: string[] }[] = [
  ...
  { key: 'asia', labelKey: 'components.liveNews.regionAsia', channelIds: ['thai-pbs', 'nation-tv', 'tnn', 'workpoint-news', 'pptv-hd36', 'thairath', 'tbs-news', 'ann-news', 'ntv-news', 'cti-news', 'cgtn', 'wion', 'ndtv', 'cna-asia', 'nhk-world', 'arirang-news', 'india-today', 'abp-news'] },
